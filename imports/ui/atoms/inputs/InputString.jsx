    ...
    return (
        <div key={props.field._id} className='field'>
            <p className="control has-icons-right">
                <input type="int" className={"input" + (props.field.requiredAtCreation ? " is-primary" : " is-link")} placeholder={props.field.label} name={props.field._id} onChange={props.onChange} />
